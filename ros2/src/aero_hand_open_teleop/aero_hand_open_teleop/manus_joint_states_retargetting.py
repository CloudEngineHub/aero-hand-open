...
class ManusJointStatesRetargetting(Node):
    def __init__(self):
        super().__init__("manus_joint_states_retargetting")
        ...
        self.get_logger().info("Manus Joint States Retargetting Node has been started.")
...
def main():
    rclpy.init()
    manus_joint_states_retargetting = ManusJointStatesRetargetting()
    rclpy.spin(manus_joint_states_retargetting)
    rclpy.shutdown()
